...
const messages = {
  vi: {
    ...
    secureAccess: 'Truy cập TeleHealth an toàn', secureSignIn: 'Đăng nhập an toàn',
    adminRole: 'Quản trị viên', systemOverview: 'Tổng quan hệ thống',
    doctorSchedule: 'Lịch khám và bệnh nhân', patientHealth: 'Đơn thuốc và chỉ số sức khỏe',
  ...
  en: {
    ...
    secureAccess: 'Secure TeleHealth access', secureSignIn: 'Secure sign-in',
    adminRole: 'Administrator', systemOverview: 'System overview',
    doctorSchedule: 'Appointments and patients', patientHealth: 'Prescriptions and health metrics',
